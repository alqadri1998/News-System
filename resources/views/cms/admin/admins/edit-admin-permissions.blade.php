                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Notes System - Update Admin Permissions</h3>
                            <a href="#" onclick="updateAdminPermissions('{{$admin->id}}')" class="btn btn-sm btn-info float-right">Update
                                Permissions</a>
                        </div>
                        <!-- /.card-header -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-8">
                                <label>Student: {{$admin->name}}</label>
                            </div>
                        </div>
                        <div class="card-body">
...
@section('scripts')
    ...
    <script>
        ...
        selectedPermissions.push('{{$adminPermission->id}}');
        ...
        function updateAdminPermissions(id) {
            axios.post('/cms/admin/' + id + '/update-permissions', {
